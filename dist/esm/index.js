...
import React__default, { useState, forwardRef, useRef, useEffect } from 'react';
...
var ConnectionPopup = function (_a) {
    ...
    return (React__default.createElement("div", { className: "modal-overlay" },
        React__default.createElement("div", { className: "modal-content" },
            React__default.createElement("h2", { className: "modal-title" }, "Connect Datasource"),
            React__default.createElement("p", { className: "modal-subtitle" }, "Stay connected and manage your tasks efficiently!"),
            React__default.createElement("form", { onSubmit: handleSubmit },
                React__default.createElement("label", null, "Host"),
                React__default.createElement("input", { type: "text", placeholder: "doworks-db.c5xugf.us-east", value: host, onChange: function (e) { return setHost(e.target.value); }, required: true }),
                React__default.createElement("label", null, "Username"),
                React__default.createElement("input", { type: "text", placeholder: "Doworks", value: username, onChange: function (e) { return setUsername(e.target.value); }, required: true }),
                React__default.createElement("label", null, "Password"),
                React__default.createElement("input", { type: "password", placeholder: "Password", value: password, onChange: function (e) { return setPassword(e.target.value); }, required: true }),
                React__default.createElement("div", { className: "input-row" },
                    React__default.createElement("div", null,
                        React__default.createElement("label", null, "Database"),
                        React__default.createElement("input", { type: "text", placeholder: "Optional", value: database, onChange: function (e) { return setDatabase(e.target.value); } })),
                    React__default.createElement("div", null,
                        React__default.createElement("label", null, "Port"),
                        React__default.createElement("input", { type: "text", placeholder: "3306", value: port, onChange: function (e) { return setPort(e.target.value); }, required: true }))),
                React__default.createElement("div", { className: "button-container" },
                    React__default.createElement("button", { type: "button", className: "cancel-btn", onClick: function () { return setIsModalOpen(false); } }, "Cancel"),
                    React__default.createElement("button", { type: "submit", className: "connect-btn", disabled: loading }, loading ? "Connecting..." : "Connect"))))));
};
