...
const asap = typeof queueMicrotask !== 'undefined' ?
  queueMicrotask.bind(_global) : ( typeof process$1 !== 'undefined' && process$1.nextTick || _setImmediate);
...
var ConnectionPopup = function (_a) {
    ...
    var _b = React.useState(""), host = _b[0], setHost = _b[1];
    var _c = React.useState(""), username = _c[0], setUsername = _c[1];
    var _d = React.useState(""), password = _d[0], setPassword = _d[1];
    var _e = React.useState(""), database = _e[0], setDatabase = _e[1];
    var _f = React.useState(""), port = _f[0], setPort = _f[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    setLoading(true);
                    return [4 /*yield*/, axios$1.post("http://localhost:3001/database/connect", payload)];
                case 2:
                    response = _a.sent();
...
Chart$1.register(ScatterController, BarController, LineController, PieController, CategoryScale, LinearScale, PointElement, BarElement, LineElement, ArcElement, plugin_tooltip, plugin_legend);
var PlotContainer = function () {
    var _a = React.useState([]), tables = _a[0], setTables = _a[1];
    var _b = React.useState([]), selectedTables = _b[0], setSelectedTables = _b[1];
    var _c = React.useState([]), plotData = _c[0], setPlotData = _c[1];
    var _d = React.useState(false), loading = _d[0], setLoading = _d[1];
    var _e = React.useState(false), showPlots = _e[0], setShowPlots = _e[1];
    ...
    var renderChart = function (plot) {
        if (!plot.data || !Array.isArray(plot.data.x) || !Array.isArray(plot.data.y)) {
            return React__namespace.createElement("p", { className: "error-text" },
                "Invalid data for ",
                plot.plot_type);
        }
        var chartData = {
        ...
        switch (plot.plot_type) {
            case "scatter":
                return React__namespace.createElement(Scatter, { data: chartData, options: commonOptions });
            case "histogram":
            case "bar":
                return React__namespace.createElement(Bar, { data: chartData, options: commonOptions });
            case "line":
                return React__namespace.createElement(Line, { data: chartData, options: commonOptions });
            case "doughnut":
            case "pie":
                return React__namespace.createElement(Pie, { data: chartData, options: commonOptions });
            default:
                return React__namespace.createElement("p", { className: "error-text" }, "Unsupported chart type");
        }
    };
    return (React__namespace.createElement("main", { className: "main-content" }, !showPlots ? (React__namespace.createElement("div", { className: "table-selection" },
        React__namespace.createElement("h3", null, "Select Tables"),
        tables.length === 0 ? (React__namespace.createElement("p", { className: "empty-message" }, "No tables available.")) : (React__namespace.createElement("ul", { className: "table-list" }, tables.map(function (table) { return (React__namespace.createElement("li", { key: table },
            React__namespace.createElement("label", null,
                React__namespace.createElement("input", { type: "checkbox", checked: selectedTables.includes(table), onChange: function () { return handleTableSelection(table); } }),
                table))); }))),
        React__namespace.createElement("div", { className: "button-container" },
            React__namespace.createElement("button", { onClick: fetchPlotData, disabled: loading || selectedTables.length === 0, className: "fetch-button ".concat(loading ? "loading" : "") }, loading ? "Loading..." : "Get Plot")))) : (React__namespace.createElement("div", { className: "charts-grid" }, plotData.length === 0 && !loading ? (React__namespace.createElement("p", { className: "empty-message" }, "No data available for selected tables.")) : (plotData.map(function (plot, index) { return (React__namespace.createElement("div", { key: index, className: "chart-card" },
        React__namespace.createElement("h3", { className: "chart-title" }, plot.plot_name || plot.plot_type),
        React__namespace.createElement("div", { className: "chart-content" }, renderChart(plot)))); }))))));
};

var DynamicDashboard = function () {
    var _a = React.useState(true), isModalOpen = _a[0], setIsModalOpen = _a[1];
    ...
    return (React__namespace.createElement("div", { className: "dashboard-container" }, isConnected ? (React__namespace.createElement(PlotContainer, null)) : (isModalOpen && (React__namespace.createElement(ConnectionPopup, { setIsModalOpen: setIsModalOpen, setConnectionStatus: handleConnectionStatus })))));
};

exports.DynamicDashboard = DynamicDashboard;
